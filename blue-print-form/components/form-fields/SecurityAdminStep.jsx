...
const SecurityAdminStep = memo(({ formData, setField }) => (
  <Card title="Governance & Administrative Controls" className="max-w-5xl mx-auto">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="space-y-1">
        ...
        <YesNo label="Employee Security Training" value={formData.employeeTraining} onChange={(v) => setField("employeeTraining", v)} />
      ...
      <div className="space-y-1 md:border-l-2 md:border-gray-300 md:pl-8">
        ...
        <YesNo label="Conducted Penetration Testing in the last 1 year" value={formData.penetrationTest} onChange={(v) => setField("penetrationTest", v)} />
      </div>
    </div>
  </Card>
));
